    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="registerformLabel"> FFG member registration </h5>
            ...
            <div class="modal-body">
                <!---Formbuilder Form--->
                <form id="insert_form" action="Xdonor.php" method="POST" enctype="multipart/form-data" class="mbr-form form-with-styler">
                    ...
                    <div class="dragArea row">
                        ...
                        <div class="col-md-6  form-group">
                            <label for="image-form1-h" class="form-control-label  ">Password
                                :</label>
                            <input type="password" name="password1" min="8" class="form-control" required="required" class="form-control ">
                        </div>

                        <div class="col-md-6  form-group">
                            <label for="image-form1-h" class="form-control-label  ">Confirm Password :
                                :</label>
                            <input type="password" name="password2" min="8" class="form-control" required="required" class="form-control ">
                        </div>
