                                    ...
                                    <table class="table table-borderless table-data3" id="Tabledata" width="100%"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <img src="imghomeless/<?php echo $row['image'];?>"
                                                        style="width:100px; height:100px"> </td>
                                                <td>
                                                    <div class="table-data-feature">
                                                        <button class="item" data-toggle="modal" data-placement="top"
                                                            title="Edit" name="Edit" id="Edit" data-toggle="modal"
                                                            data-target="#EditFormModal">Edit
                                                            <i class="zmdi zmdi-edit zmdi-hc-5x mdc-text-green"></i>
                                                        </button>
                                                        <button class="item" data-toggle="modal" data-placement="top"
                                                            title="Delete" name="Delete" id="Delete">Delete
                                                            <i class="zmdi zmdi-delete zmdi-hc-3x mdc-text-green"></i>
                                                        </button>
                                                    </div>
                                                </td>
                                            </tr>
            ...
            <div class="modal-body">
                ...
                <form id="insert_form" action="Xreghomeless.php" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="dragArea row">
                        ...
                        <div class="col-md-6  form-group">
                            <label for="race-form1-h" class="form-control-label mbr-fonts-style display-7">Race
                            </label>
                            ...
                            <div class="form-check">
                                <input class="form-check-input display-7" type="checkbox" name="race" id="rRace"
                                    value="Chinese">
                                <label class="form-check-label" for="rChinese">Chinese
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    &nbsp;&nbsp; &nbsp;&nbsp;</label>

                                <input class="form-check-input  display-7" type="checkbox" name="race" id="rRace4"
                                    value="Other" onClick="Function()"
                                    onchange="document.getElementById('race4').disabled = !this.checked;">
                                <label class="form-check-label">Other&nbsp;</label>
                                <input id="race4" type="text" name="race" class="form-control form-control-sm"
                        ...
                        <div class="col-md-6 form-group ">
                            ...
                            <div class="form-check ">
                                <input class="form-check-input display-7" type="checkbox" id="health" value="Good"
                                    name="medCondition">
                            ...
                            <div class="form-check">
                                <input class="form-check-input display-7" type="checkbox" id="health1" value="other :"
                                    onClick="myFunction()" onClick="ChangePlaceHolderColor()"
                                    onchange="document.getElementById('un').disabled = !this.checked;">
                                <label class="form-check-label mbr-fonts-style display-7" for="inlineCheckbox2">Other
                                    &nbsp;</label>
                                <input id="un" type="text" name="medCondition" class="form-control form-control-sm "
