...
<div class="modal fade" id="ModalView_Volunteer<?php echo $row['id_volunteer']; ?>" tabindex="-1" role="dialog"
    aria-labelledby="largeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="registerformLabel"> View Volunteers </h5>
            ...
            <div class="modal-body">
                ...
                <form id="insert_form" action="" method="" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        <div hidden="hidden" data-form-alert="" class="alert alert-success col-12">Volunteers
                    ...
                    <div class="dragArea row">
                        ...
                        <div class="col-md-12  form-group" style="text-align:center">
                            <img src="ImgVolunteer/<?php echo $row['']; ?>"
                        ...
                        <div class="col-md-10 form-group">
                            <input type="text" class="form-control" name="address1" required=""
                                value="<?php echo $row['address1'];?>" placeholder="Street Address" disabled>
                        </div>
                        ...
                        <div class="col-md-10 form-group">
                            <input type="text" class="form-control" name="address2"
                                value="<?php echo $row['address2'];?>" placeholder="Street Address Line 2" disabled>
                        </div>
                        ...
                        <div class="col-md-4 form-group">
                            <input type="text" class="form-control" name="state" value="<?php echo $row['state'];?>"
                                placeholder="State / Province" disabled>
                        </div>
