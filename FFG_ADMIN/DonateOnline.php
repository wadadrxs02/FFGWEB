...
<!-- Title Page-->
<title>Admin | Online Donation Record</title>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="overview-wrap">
                                    <h2 class="title-1">Online Donation Information</h2>
                                    ...
                                    <table class="table table-borderless table-data3" id="DataTable" width="100%"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo date('d M Y  h:i:s A', strtotime($row['don_date'])); ?></td>
