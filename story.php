<?php include_once'header.php';
  ...
  $sql = mysqli_query ($connection, "SELECT * FROM blog  ORDER BY id_blog DESC LIMIT 1");
                    ...
                    <div class="row no-gutters">
                        ...
                        <div class="col-10 col-sm-11">
                            <div class="single-post">
                                <!-- Post Thumb.  -->
                                <?php   $sql = mysqli_query ($connection, "SELECT * FROM blog ORDER BY id_blog DESC LIMIT 1");
                                        $print_data = mysqli_fetch_row($sql);
                                    ?>
                                <div class="post-thumb1">
                                    <img src="img/imgPost/<?php echo $print_data[4];?>" alt="">
                                </div>
                                <!-- Post Content -->
                                <div class="post-content">
                                    <div class="post-meta d-flex">
                                        <div class="post-author-date-area d-flex">
                                            ...
                                            <!-- Post Date -->
                                            <div class="post-date">
                                                <a href="#"><?php echo $print_data[3];?></a>
                                            </div>
                                        </div>
                                    ...
                                    <a href="#">
                                        <h2 class="post-headline"><?php echo $print_data[1];?></h2>
                                    </a>
                                    <p><?php echo $print_data[2];?> </p>
