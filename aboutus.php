...
<body>
                        ...
                        <div class="card" style="border-color:#00ad5f">
                            <div class="card-body">
                                <div class="contact-form wow fadeInUpBig" data-wow-delay="0.6s">
                                    <h2 class="contact-form-title mb-30">Contact Us !
                                    </h2>
                                    <!--Contact Form-->
                                    <form action="https://submit-form.com/B0-yKu505ehRZbfQ3bgYF" method="post">
    ...
    <section class="contacts4 cid-rCVbpQ5Kz8" id="contacts4-e">
        <div class="main_wrapper">
            <div class="b_wrapper">
                <div class="container">
                    <!-- yang asal punye      <div class="row">
                        <div class="col-12 col-md-5 p-0">
                            <div class="block p-5">
                                <div class="block_wrapper">
                                    <h4 class="align-left mbr-fonts-style pb-4 m-0 display-5">FFG Team</h4>
                                    <p class="mbr-text align-left mbr-fonts-style pb-4 m-0 display-7">+60
                                        177757156&nbsp;<br>inquiry.foodforgelandangan@mail.com</p>
                            ...
                            <div class="col-12 col-md-5 p-0">
                                <div class="block p-5">
                                    <div class="block_wrapper">
                                        ...
                                        <p class="mbr-text align-left mbr-fonts-style pb-4 m-0 display-7">+60
                                            177757156&nbsp;<br>inquiry.foodforgelandangan@mail.com</p>
                                        <p class="mbr-text align-left mbr-fonts-style m-0 display-7">55 &amp; 57, Jalan
                                            Tun
                                            Tan Siew Sin, Malaysia, 50050 Kuala Lumpur, Wilayah Persekutuan Kuala
                                            Lumpur<br>
                                        </p>
                                    </div>
                                </div>
